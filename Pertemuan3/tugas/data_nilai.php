...
<head>
    ...
    <style>
        ...
        .container {
            max-width: 900px;
            margin: 0 auto;
            background-color: #9195F6; /* Warna latar dari container diubah ke putih untuk kontras dengan bayangan */
            padding: 20px;
            border-radius: 10px;
            box-shadow: 0 3px 6px rgba(255,255,255,0.5); /* Bayangan putih, tapi mungkin tidak terlihat jelas */
            text-align: center;
            border: 1px solid #9195F6; /* Alternatif: menggunakan border untuk efek yang lebih jelas */
        }
